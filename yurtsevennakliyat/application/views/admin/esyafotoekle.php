...
<head>
  ...
  <title>EŞYA FOTOĞRAF EKLE</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">EŞYA FOTOĞRAF EKLE</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">ANA SAYFA</a></li>
              <li class="breadcrumb-item active">EŞYA FOTOĞRAF EKLE</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <form action="<?php echo base_url('admin/esyagaleriekle'); ?>" role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="eg_aciklama" id="" rows="5" class="form-control"></textarea>
        ...
        <div class="form-group">
            ...
            <input name="eg_resim" class="form-control" type="file">
        ...
        <button style="margin-left:500px;" name="save" type="submit" class="btn btn-info">EKLE</button>
